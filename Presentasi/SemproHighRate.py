...
class SemproHighRate(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SemproHighRate")
        ...
        self.blocks_throttle2_0.set_min_output_buffer(minOutputBuffer)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.radar_static_target_simulator_cc_0, 0))
...
def main(top_block_cls=SemproHighRate, options=None):
